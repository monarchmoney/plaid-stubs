...
class PaymentInitiationPayment(ModelNormal):
    ...
    bacs: Any = ...
    iban: Any = ...
    def __init__(self, payment_id: Any, amount: Any, status: Any, recipient_id: Any, reference: Any, last_status_update: Any, bacs: Any, iban: Any, *args: Any, **kwargs: Any) -> None: ...
