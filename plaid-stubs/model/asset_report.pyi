...
class AssetReport(ModelNormal):
    ...
    asset_report_id: Any = ...
    client_report_id: Any = ...
    date_generated: Any = ...
    days_requested: Any = ...
    user: Any = ...
    items: Any = ...
    def __init__(self, asset_report_id: Any, client_report_id: Any, date_generated: Any, days_requested: Any, user: Any, items: Any, *args: Any, **kwargs: Any) -> None: ...
