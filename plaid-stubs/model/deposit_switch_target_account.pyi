...
class DepositSwitchTargetAccount(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    account_name: Any = ...
    account_subtype: Any = ...
    def __init__(self, account_number: Any, routing_number: Any, account_name: Any, account_subtype: Any, *args: Any, **kwargs: Any) -> None: ...
