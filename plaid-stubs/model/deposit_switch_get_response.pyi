...
class DepositSwitchGetResponse(ModelNormal):
    ...
    target_item_id: Any = ...
    state: Any = ...
    account_has_multiple_allocations: Any = ...
    is_allocated_remainder: Any = ...
    percent_allocated: Any = ...
    amount_allocated: Any = ...
    date_created: Any = ...
    date_completed: Any = ...
    request_id: Any = ...
    def __init__(self, deposit_switch_id: Any, target_account_id: Any, target_item_id: Any, state: Any, account_has_multiple_allocations: Any, is_allocated_remainder: Any, percent_allocated: Any, amount_allocated: Any, date_created: Any, date_completed: Any, request_id: Any, *args: Any, **kwargs: Any) -> None: ...
