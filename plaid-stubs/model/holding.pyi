...
class Holding(ModelNormal):
    ...
    account_id: Any = ...
    security_id: Any = ...
    institution_price: Any = ...
    institution_value: Any = ...
    quantity: Any = ...
    def __init__(self, account_id: Any, security_id: Any, institution_price: Any, institution_value: Any, quantity: Any, *args: Any, **kwargs: Any) -> None: ...
