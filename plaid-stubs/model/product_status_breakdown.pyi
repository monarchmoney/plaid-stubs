...
class ProductStatusBreakdown(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    success: Any = ...
    error_plaid: Any = ...
    error_institution: Any = ...
    def __init__(self, success: Any, error_plaid: Any, error_institution: Any, *args: Any, **kwargs: Any) -> None: ...
