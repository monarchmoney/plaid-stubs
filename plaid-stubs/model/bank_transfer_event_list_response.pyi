...
class BankTransferEventListResponse(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    required_properties: Any = ...
    bank_transfer_events: Any = ...
    request_id: Any = ...
    def __init__(self, bank_transfer_events: Any, request_id: Any, *args: Any, **kwargs: Any) -> None: ...
