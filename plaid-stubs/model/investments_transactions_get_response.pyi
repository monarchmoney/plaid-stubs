...
class InvestmentsTransactionsGetResponse(ModelNormal):
    ...
    total_investment_transactions: Any = ...
    request_id: Any = ...
    def __init__(self, item: Any, accounts: Any, securities: Any, investment_transactions: Any, total_investment_transactions: Any, request_id: Any, *args: Any, **kwargs: Any) -> None: ...
