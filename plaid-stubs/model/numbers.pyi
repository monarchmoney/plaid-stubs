...
class Numbers(ModelNormal):
    ...
    account: Any = ...
    ach_routing: Any = ...
    ach_wire_routing: Any = ...
    eft_institution: Any = ...
    eft_branch: Any = ...
    international_bic: Any = ...
    international_iban: Any = ...
    bacs_sort_code: Any = ...
    def __init__(self, account: Any, ach_routing: Any, ach_wire_routing: Any, eft_institution: Any, eft_branch: Any, international_bic: Any, international_iban: Any, bacs_sort_code: Any, *args: Any, **kwargs: Any) -> None: ...
