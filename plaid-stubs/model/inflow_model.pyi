...
class InflowModel(ModelNormal):
    ...
    statement_day_of_month: Any = ...
    def __init__(self, type: Any, income_amount: Any, payment_day_of_month: Any, transaction_name: Any, statement_day_of_month: Any, *args: Any, **kwargs: Any) -> None: ...
