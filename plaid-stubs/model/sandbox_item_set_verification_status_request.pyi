...
class SandboxItemSetVerificationStatusRequest(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    def __init__(self, access_token: Any, account_id: Any, verification_status: Any, *args: Any, **kwargs: Any) -> None: ...
