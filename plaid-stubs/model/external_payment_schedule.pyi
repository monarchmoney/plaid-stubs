...
class ExternalPaymentSchedule(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    required_properties: Any = ...
    interval: Any = ...
    interval_execution_day: Any = ...
    start_date: Any = ...
    def __init__(self, interval: Any, interval_execution_day: Any, start_date: Any, *args: Any, **kwargs: Any) -> None: ...
