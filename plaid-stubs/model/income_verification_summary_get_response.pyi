...
class IncomeVerificationSummaryGetResponse(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    required_properties: Any = ...
    income_summaries: Any = ...
    request_id: Any = ...
    def __init__(self, income_summaries: Any, request_id: Any, *args: Any, **kwargs: Any) -> None: ...
