...
class PaymentStatusUpdateWebhook(ModelNormal):
    ...
    webhook_code: Any = ...
    payment_id: Any = ...
    new_payment_status: Any = ...
    old_payment_status: Any = ...
    timestamp: Any = ...
    def __init__(self, webhook_type: Any, webhook_code: Any, payment_id: Any, new_payment_status: Any, old_payment_status: Any, timestamp: Any, *args: Any, **kwargs: Any) -> None: ...
