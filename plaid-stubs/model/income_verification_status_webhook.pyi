...
class IncomeVerificationStatusWebhook(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    webhook_type: Any = ...
    webhook_code: Any = ...
    income_verification_id: Any = ...
    verification_status: Any = ...
    def __init__(self, webhook_type: Any, webhook_code: Any, income_verification_id: Any, verification_status: Any, *args: Any, **kwargs: Any) -> None: ...
