...
class BankTransferCreateRequest(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    description: Any = ...
    user: Any = ...
    def __init__(self, idempotency_key: Any, access_token: Any, account_id: Any, type: Any, network: Any, amount: Any, iso_currency_code: Any, description: Any, user: Any, *args: Any, **kwargs: Any) -> None: ...
