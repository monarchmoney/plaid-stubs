...
class DepositSwitchCreateRequest(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    required_properties: Any = ...
    target_access_token: Any = ...
    target_account_id: Any = ...
    def __init__(self, target_access_token: Any, target_account_id: Any, *args: Any, **kwargs: Any) -> None: ...
