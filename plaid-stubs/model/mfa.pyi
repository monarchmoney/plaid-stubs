...
class MFA(ModelNormal):
    ...
    type: Any = ...
    question_rounds: Any = ...
    questions_per_round: Any = ...
    selection_rounds: Any = ...
    selections_per_question: Any = ...
    def __init__(self, type: Any, question_rounds: Any, questions_per_round: Any, selection_rounds: Any, selections_per_question: Any, *args: Any, **kwargs: Any) -> None: ...
