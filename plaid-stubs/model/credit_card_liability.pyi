...
class CreditCardLiability(ModelNormal):
    ...
    last_statement_issue_date: Any = ...
    minimum_payment_amount: Any = ...
    next_payment_due_date: Any = ...
    def __init__(self, aprs: Any, last_payment_amount: Any, last_payment_date: Any, last_statement_issue_date: Any, minimum_payment_amount: Any, next_payment_due_date: Any, *args: Any, **kwargs: Any) -> None: ...
