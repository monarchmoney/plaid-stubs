...
class PendingExpirationWebhook(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    def __init__(self, webhook_type: Any, webhook_code: Any, item_id: Any, consent_expiration_time: Any, *args: Any, **kwargs: Any) -> None: ...
