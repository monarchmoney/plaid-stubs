...
class InvestmentTransaction(ModelNormal):
    ...
    type: Any = ...
    subtype: Any = ...
    def __init__(self, investment_transaction_id: Any, account_id: Any, date: Any, name: Any, quantity: Any, amount: Any, price: Any, type: Any, subtype: Any, *args: Any, **kwargs: Any) -> None: ...
