...
class InstitutionStatus(ModelNormal):
    ...
    item_logins: Any = ...
    transactions_updates: Any = ...
    auth: Any = ...
    balance: Any = ...
    identity: Any = ...
    investments_updates: Any = ...
    def __init__(self, item_logins: Any, transactions_updates: Any, auth: Any, balance: Any, identity: Any, investments_updates: Any, *args: Any, **kwargs: Any) -> None: ...
