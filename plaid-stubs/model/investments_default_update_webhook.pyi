...
class InvestmentsDefaultUpdateWebhook(ModelNormal):
    ...
    webhook_code: Any = ...
    item_id: Any = ...
    new_investments_transactions: Any = ...
    canceled_investments_transactions: Any = ...
    def __init__(self, webhook_type: Any, webhook_code: Any, item_id: Any, new_investments_transactions: Any, canceled_investments_transactions: Any, *args: Any, **kwargs: Any) -> None: ...
