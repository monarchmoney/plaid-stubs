...
class AssetReportFilterResponse(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    required_properties: Any = ...
    asset_report_token: Any = ...
    asset_report_id: Any = ...
    request_id: Any = ...
    def __init__(self, asset_report_token: Any, asset_report_id: Any, request_id: Any, *args: Any, **kwargs: Any) -> None: ...
