...
class RecaptchaRequiredError(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    ...
    display_message: Any = ...
    http_code: Any = ...
    link_user_experience: Any = ...
    common_causes: Any = ...
    troubleshooting_steps: Any = ...
    def __init__(self, error_type: Any, error_code: Any, display_message: Any, http_code: Any, link_user_experience: Any, common_causes: Any, troubleshooting_steps: Any, *args: Any, **kwargs: Any) -> None: ...
