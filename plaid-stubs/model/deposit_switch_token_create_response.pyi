...
class DepositSwitchTokenCreateResponse(ModelNormal):
    allowed_values: Any = ...
    validations: Any = ...
    attribute_map: Any = ...
    required_properties: Any = ...
    deposit_switch_token: Any = ...
    deposit_switch_token_expiration_time: Any = ...
    request_id: Any = ...
    def __init__(self, deposit_switch_token: Any, deposit_switch_token_expiration_time: Any, request_id: Any, *args: Any, **kwargs: Any) -> None: ...
